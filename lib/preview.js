...
var Preview = function (_React$Component) {
  ...
  {
    key: '_onCheckSave',
    value: function _onCheckSave(item) {
      _store2.default.dispatch('checked', item);
    }
  },{
    key: '_onDestroy',
    ...
    value: function cardPlaceHolder(dragIndex, hoverIndex) {
      // Dummy
      //console.log("In CardPlaceHolder method");
    }
  }, {
    key: 'saveData',
    ...
    value: function getElement(item, index) {
      ...
      return _react2.default.createElement(SortableFormElement, {
		...
		_onCheckSave: this._onCheckSave
      });
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.editElement !== null && _react2.default.createElement(_formElementsEdit2.default, {
            ...
            manualEditModeCancel: this.props.manualEditModeCancel,
            editModeOff: this.props.editModeOff,
            preview: this,
...
Preview.defaultProps = {
  ...
  editMode: false,
  editElement: null,
  className: 'react-form-builder-preview pull-right'
};